                    ...
                    <body>
                        ...
                        <div>
                            ...
                            <table style="margin-left: 50px">
                                ...
                                <tr>
                                    <th>Name</th>
                                    <td><input placeholder="Name" style="margin-left:10px"></td>
                                </tr>
                                <tr>
                                    <th>Card Number</th>
                                    <td><input style="margin-left:10px" type="number" placeholder="0000 0000 0000 0000"
                                            max="9999999999999999"></td>
                                </tr>
                                <tr>
                                    <th>CVS</th>
                                    <td><input style="margin-left:10px" type="number" placeholder="000" max="999"></td>
                                </tr>
                                <tr>
                                    <th>Expiry Date</th>
                                    <td><input style="margin-left:10px" placeholder="MM/YY"></td>
                                </tr>
                                <tr>
                                    <th>
                                        <button
