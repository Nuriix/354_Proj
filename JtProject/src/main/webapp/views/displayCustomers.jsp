	...
	<div class="container">
	   <div class="row">
		   ...
		   <div class="col-10">
			   ...
			   <p>Displaying ### customers</p>
			   <button class="btn"><i class="fas fa-search"></i></button>
			   <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search">

			   <!-- Button trigger modal -->
        <button type="button" style="margin: 20px 0" class="btn btn-outline-success m-2 align-self-center"
				data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i  class="fas fa-plus"></i></button>
